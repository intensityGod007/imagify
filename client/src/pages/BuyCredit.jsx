...
const BuyCredit = () => {
  ...
  const { user, backendUrl, loadCreditsData, token, setShowLogin } = React.useContext(AppContext)
  ...
  return (
    ...
    >
      ...
      <h1 className='text-center text-3xl font-medium mb-6 sm:mb-6'>Choose the plan</h1>
