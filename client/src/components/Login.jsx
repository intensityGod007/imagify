...
const Login = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            if (state === 'Login') {
                const { data } = await axios.post(backendUrl + '/api/user/login', { userId: "", email, password })
    ...
    return (
        <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
            ...
            >
                ...
                {state !== 'Login' && <div className='px-6 py-2 flex items-center gap-2 border rounded-full mt-5'>
                ...
                <div className='px-6 py-2 flex items-center gap-2 border rounded-full mt-4'>
                    {/* <img src={assets.user_icon} alt="" /> */}
